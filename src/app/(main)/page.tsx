...
const ValentinePage = () => {
  const handleResponderClick = () => {
    ...
    Swal.fire({
      ...
      customClass: {
        ...
        confirmButton: 'px-6 py-3 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-110  focus:outline-none focus:ring-2  focus:ring-opacity-50',
        cancelButton: 'px-6 py-3 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-110 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50',
      ...
      if (result.isConfirmed) {
        ...
        Swal.fire({
          ...
          Swal.fire({
            ...
            customClass: {
              title: 'text-3xl font-semibold text-gray-800 mb-4', // Estilo del título
              confirmButton: 'px-6 py-3 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-110  focus:ring-opacity-50',
              cancelButton: 'px-6 py-3 text-lg font-semibold rounded-full transition-all duration-300 hover:scale-110 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-opacity-50',
              htmlContainer: 'text-lg text-gray-800', // Estilo del texto
            },
            showClass: {
  ...
  return (
    <div className="min-h-screen w-full bg-purple-100 shadow-2xl rounded-2xl">
      ...
      <section
        id="features"
        className="container mx-auto px-4 s:h-screen  py-10 xl:py-20"
      >
            ...
            <CardWithFlipEffect
              frontContent={
                <div className="flex flex-col items-center justify-center">
                  ...
                  <h3 className="text-xl font-bold mb-4">Un Mensaje para Ti</h3>
